import { Href, ImagePath, PainterTourTitle, ReadMoreTour, WilliamJennings, WonderfulTour } from "@/Constants";
    ...
    <>
      ...
      <div className="img-container">
        <div id="aniimated-thumbnials">
          <Link href={Href}>
            <Image width={1539} height={444} className="img-fluid rounded" src={`${ImagePath}/other-images/profile-style-img3.png`} alt="gallery" />
          </Link>
          <p className="block-ellipsis pt-3">
            {PainterTourSpan}
            <Link className="txt-danger ms-1" href={`/miscellaneous/blog/blog-single`}>{ReadMoreTour}</Link>
          </p>
        </div>
      </div>
    </>
