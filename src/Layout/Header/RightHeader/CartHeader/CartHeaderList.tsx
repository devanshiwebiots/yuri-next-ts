      ...
      {items.length > 0 ? (
        <>
          ...
          <li className="text-center">
            <Link className="d-block mb-3 view-cart f-w-700" href={`/applications/ecommerce/cart`}>
              {Gotoyourcart}
            </Link>
            <Link className="btn btn-primary view-checkout w-100" href={`/applications/ecommerce/checkout`}>
              {Checkout}
            </Link>
          </li>
        </>
