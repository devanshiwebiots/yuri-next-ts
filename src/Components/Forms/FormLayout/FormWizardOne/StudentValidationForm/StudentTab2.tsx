...
import { AddProfile, ImagePath, PortfolioURL, ProjectDescription } from "@/Constants";
import { StudentFormPropsType } from "@/Types/Form";
  ...
  return (
      <Row className="g-3 avatar-upload">
        ...
        <Col xs="12">
          ...
          <Input value={portfolioURL} onChange={getUserData} name="portfolioURL" type="url" placeholder="https://yuri" />
        </Col>
        <Col xs="12">
