...
import { AadharPlaceholder, AllTheAboveInformationIsCorrect, CVVNumber, CardNumber, Expiration, UploadDocumentation } from "@/Constants";
import { CardDetailProp } from "@/Types/Form";
