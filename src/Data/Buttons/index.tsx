// import { Clock, Loader, Radio } from "react-feather";

// export const SquareButtonData = [
//   {
...
// export const OutlineButtonSubTitle = [
//   {
//     text: "Add ",
//     code: ".btn-pill ",
//   },
...
// export const OutlineButtonSizeData = [
//   {
//     text: "Default Button",
//     color: "secondary",
//     size: "md",
...
// export const RoundedButtonSubTitle = [
//   {
//     text: "Add ",
//     code: ".btn-pill ",
//   },
...
// export const RoundedButtonData = [
//   {
//     text: "Users",
//     color: "light-dark",
//   },
...
// export const OutlineRoundedSubTitle = [
//   {
//     text: "Add ",
//     code: ".btn-pill ",
//   },
...
// export const RoundedSizessubTitle = [
//   {
//     text: "Use the ",
//     code: ".btn-lg,.btn-sm,.btn-xs ",
//   },
...
// export const OutlineRoundedSizeSubTitle = [
//   {
//     text: "Use the ",
//     code: ".btn-lg,.btn-sm,.btn-xs ",
//   },
...
// export const DisabledButtonData = [
//   {
//     text: "Having problems",
//     classes: "btn-pill btn-warning ",
//   },
//   {
//     text: "Inaccessible",
...
//   {
//     text: "Disabled",
//     classes: "btn-pill btn-outline-warning ",
//   },
// ];
// export const IconButtonsSubHeading = [
//   {
...
//   { color: "warning", icon: <Loader /> },
//   { color: "light-primary", icon: <Radio /> },
//   { color: "light-secondary", icon: <Loader />, className: "btn-pill" },
//   { color: "light-warning ", className: "btn-pill", icon: <Radio /> },
//   { outline: true, color: "primary", icon: <Radio /> },
//   { outline: true, color: "secondary", icon: <Loader />, className: "btn-pill border border-secondary" },
//   { outline: true, color: "warning", icon: <Radio />, className: "btn-pill border border-warning" },
// ];

// export const ButtonGroupSubHeading = [
//   {
...
// export const BlockLevelButtonsSubHeading = [
//   {
//     code: ".btn ",
//   },
//   {
...
// export const ButtonVariationSubHeading = [
//   {
//     code: ".btn ",
//   },
//   {
...
import { BasicDropdownType, BlockLevelButtonsItems, ButtonGroupItems, GradientButtonsTypes } from "../../Types/Buttons";
