...
const ProjectOverview = () => {
  return (
    <Col xl="6" className="box-col-6 order-md-vii">
      <Card className=" title-line">
        ...
        <CardBody className="pt-0">
          <div className="project-overview-wrapper">
            <ReactApexChart height="290" type="line" series={ProjectOverviewChart2Options.series} options={ProjectOverviewChart2Options} />
            <div className="project-back-bar">
              <ReactApexChart height="180" type="bar" series={ProectOverviewChartOptions.series} options={ProectOverviewChartOptions} />
            </div>
          </div>
        </CardBody>
      </Card>
