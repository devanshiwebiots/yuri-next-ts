...
import { YuriMail, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourName, Name, Password } from "@/Constants";
import { StudentTabProp } from "@/Types/Form";
  ...
  return (
    <Row className="g-3">
      ...
      <Col sm="6">
        ...
        <Input name="email" onChange={getUserData} value={email} type="email" placeholder={YuriMail} />
      </Col>
      <Col xs="12">
