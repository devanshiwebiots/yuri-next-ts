...
import { SwitchWithIcon } from "@/Constants";
import CommonCardHeader from "@/CommonComponents/CommonCardHeader";
import { SwitchIconData, SwitchIconDataList } from "@/Data/Forms";

const SwitchWithIcons = () => {
  return (
    <Col md="12">
      <Card className="title-line">
        <CommonCardHeader title={SwitchWithIcon} subTitle={SwitchIconData} />
