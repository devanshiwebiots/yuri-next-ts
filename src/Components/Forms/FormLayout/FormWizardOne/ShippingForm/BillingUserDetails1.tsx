...
import { Address, YuriMail, ContactNumber, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName } from "@/Constants";
import { BillingUserDetailsProp } from "@/Types/Form";
  ...
  return (
    <>
      ...
      <Col sm="6">
        ...
        <Input value={email} onChange={getUserData} name="email" type="email" placeholder={YuriMail} />
      </Col>
      <Col sm="12">
