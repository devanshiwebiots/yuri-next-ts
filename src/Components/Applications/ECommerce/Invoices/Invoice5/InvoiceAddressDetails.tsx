  ...
  return (
    <>
      <td style={{padding:0}}>
        ...
        <span style={{ fontSize: 16, display: "block", color: "var(--normal-gray)", opacity: "0.8", marginBottom: 8, width: "72%", lineHeight: "1.4" }}>2972 Westheimer Rd. Santa Ana, Illinois 85486</span>
